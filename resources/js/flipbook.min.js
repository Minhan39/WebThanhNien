    ...
    (M.fn.flipBook = function (e) {
        ...
        (FLIPBOOK.Main = function (e, t) {
            ...
            if (
                ...
                "simple" == P.viewMode &&
                    ((P.viewMode = "3d"), (P.instantFlip = !0)),
                "webgl" == P.viewMode &&
                    (!this.hasWebGl ||
                        (parseFloat(
                            !!(w = (v = (
                                v || navigator.userAgent
                            ).toLowerCase()).match(/android\s([0-9\.]*)/)) &&
                                w[1]
                ...
                P.menuFloating &&
                    ((P.menuOverBook = !0), (P.sideMenuOverMenu = !0)),
                P.menu2Floating &&
                    ((P.menu2OverBook = !0), (P.sideMenuOverMenu2 = !0)),
                P.menuTransparent &&
                    ((P.menuOverBook = !0),
                ...
                B.on("pageLoaded", function (e) {
                    ...
                    B.on("pageUnloaded", function (e) {
                        e.unloadedPages.forEach(function (e) {
                            n.Book.onPageUnloaded &&
                                n.Book.onPageUnloaded(e.index, e.size);
                        });
                    }),
                    B.on("pdfinit", function () {
                        (P.tableOfContent =
                            n.pdfService.outline || P.tableOfContent),
                        ...
                        (P.pageWidth = parseInt(
                            (i * n.viewportOriginal.width) /
                                n.viewportOriginal.height
                        )),
                            (P.pageHeight = i),
                            (P.pw = P.pageWidth),
                            (P.ph = P.pageHeight),
                    ...
                    B.on("toolSelect", function () {
                        n.bookLayer.removeClass("flipbook-move"),
                            n.btnSelect &&
                                n.btnSelect.addClass("flipbook-btn-active"),
                            M(".flipbook-page-htmlContent").css(
                                "userSelect",
                                "auto"
                            );
                    }),
                    B.on("toolMove", function () {
                        n.bookLayer.addClass("flipbook-move"),
                            n.btnSelect &&
                                n.btnSelect.removeClass("flipbook-btn-active"),
                            M(".flipbook-page-htmlContent").css(
                                "userSelect",
                                "none"
                            );
                    ...
                    P.lightBox
                        ? ((P.btnClose.enabled = !0),
                          (this.lightbox = new FLIPBOOK.Lightbox(
                              this,
                              this.wrapper,
                              P
                          )),
            ...
            function O() {
                if (P.fillPreloader.enabled) {
                    n.$fillPreloader = M("<div>").addClass(
                            ...
                            (e.src = P.fillPreloader.imgFull),
                                (e.onload = function () {
                                    M(t).appendTo(n.$fillPreloader),
                                        (n.$fillPreloaderImg = M(e).appendTo(
                                            n.$fillPreloader
                                        )),
        ...
        (FLIPBOOK.Main.prototype = {
                    ...
                    this.started ||
                        ...
                        this.options.numPages % 2 == 0
                            ? (this.options.numSheets =
                                  (this.options.numPages + 2) / 2)
                            : (this.options.numSheets =
                                  (this.options.numPages + 1) / 2),
                        (this.started = !0),
                ...
                this.started || this.start(),
                    void 0 !== this.Book
                        ? (this.Book.enable(),
                          ...
                          this.options.thumbnailsOnStart &&
                              this.toggleThumbs(!0),
            ...
            updateCurrentPage: function () {
                if (void 0 !== this.currentPage) {
                    ...
                    t && (i = this.options.pages.length - i),
                        ...
                        t
                            ? (this.enableNext(0 < i),
                              this.enablePrev(i < o - 1))
                            : (this.enablePrev(0 < i),
                              this.enableNext(i < o - 1)),
                        2 == this.cPage.length
            ...
            initJpg: function () {
                ...
                1 == this.options.numPages &&
                    ...
                    this.loadPage(0, this.options.pageTextureSize, function () {
                        if (
                            (n.setLoadingProgress(0.5),
                            1 == n.options.pages.length)
                        ) {
                            ...
                            (n.options.pw = e.width),
                                ...
                                (n.options.zoomSize =
                                    n.options.zoomSize || e.height),
                                n.setLoadingProgress(0.7),
                                n.start();
                        } else
                            n.loadPage(
                                1,
                                n.options.pageTextureSize,
                                function () {
                                    var e = n.options.pages[0].img,
            ...
            initPdf: function (e) {
                if (!this.started) {
                    ...
                    this.setLoadingProgress(0.3),
                        ...
                        (PDFJS = pdfjsLib),
                        (pdfjsLib.externalLinkTarget =
                            pdfjsLib.LinkTarget.BLANK),
                        (pdfjsLib.GlobalWorkerOptions.workerSrc =
                            this.options.pdfjsworkerSrc ||
                            FLIPBOOK.pdfjsworkerSrc),
                    ...
                    this.pdfinitStarted ||
                        ...
                        pdfjsLib.getDocument(o).then(function (e) {
                            ...
                            !t.options.tableOfContent ||
                                t.options.tableOfContent.length;
                            t.pdfService.init();
                        }));
                }
            },
            ...
            createBook: function () {
                ...
                if (
                    (n.setLoadingProgress(0.9), "webgl" == n.options.viewMode)
                ) {
                ...
                if (
                    (this.setLoadingProgress(1),
                    this.initEasing(),
                    "doubleWithCover" == n.options.pageMode &&
                        2 < n.options.pages.length)
                ) {
                    for (
                ...
                function l() {
                    (n.flipsound = C.createElement("audio")),
                        n.flipsound.setAttribute(
                            "src",
                            n.options.assets.flipMp3
                        ),
                ...
                if ("webgl" == n.options.viewMode) {
                    var d = n.options;
                    (d.scroll = n.scroll),
                        ((d.parent = n).Book = new FLIPBOOK.BookWebGL(
                            n.book[0],
                            e,
                            d
                        )),
                    ...
                    "swipe" == n.options.viewMode
                        ? ((n.Book = new FLIPBOOK.BookSwipe(
                          ...
                          n.initSwipe())
                        : ("2d" != n.options.viewMode &&
                              (n.options.viewMode = "3d"),
            ...
            createButton: function (t) {
                var o = this.options,
                    ...
                    i =
                        t.background ||
                        (e ? o.floatingBtnBackground : o.btnBackground),
                    n =
                        t.backgroundHover ||
                        (e
                            ? o.floatingBtnBackgroundHover
                            : o.btnBackgroundHover),
                    s = t.color || (e ? o.floatingBtnColor : o.btnColor),
                    a =
                        t.colorHover ||
                        (e ? o.floatingBtnColorHover : o.btnColorHover),
                ...
                (this.menuBottom = M(C.createElement("div"))
                    ...
                    e.isMobile &&
                        ...
                        void 0 !== e.btnDownloadPagesIfMobile &&
                            (e.btnDownloadPages.hideOnMobile =
                                !e.btnDownloadPagesIfMobile),
                        void 0 !== e.btnDownloadPdfIfMobile &&
                            (e.btnDownloadPdf.hideOnMobile =
            ...
            setFillPreloaderProgress: function (e) {
                if (this.$fillPreloader)
                    if (0 < e && e < 1) {
                        if (
                            ((this.fillPreloaderProgress =
                                this.fillPreloaderProgress || 0),
            ...
            zoomTo: function (e, t, o) {
                ...
                (this.zoom = e),
                    void 0 === o
                        ? ((i = this.model.wrapperW / 2),
                          (n = this.model.wrapperH / 2))
                        : ((n =
            ...
            createCurrentPage: function () {
                ...
                var n =
                    ...
                    d =
                        (n ? i.floatingBtnMargin : i.btnMargin,
                        M("<div>").appendTo(e));
                d.css(
                    "margin",
                ...
                var h = M("<form>")
                    ...
                    .submit(function (e) {
                        ...
                        return (
                            ...
                            o.options.rightToLeft &&
                                (t = i.pages.length - t + 1),
                            o.goToPage(t),
                ...
                (this.currentPageInput = M('<input type="text" maxlength="4">')
                    ...
                    .css({
                        margin:
                            i.currentPage.marginV +
                            "px " +
                            i.currentPage.marginH +
                            "px",
                        color: a,
                    })
                    .appendTo(h)
                    ...
                    .focus(function () {
                        o.currentPageInput.val(""),
                            o.currentPage.addClass(
                                "flipbook-color-transparent"
                            );
                    })
                    .blur(function () {
                        o.currentPageInput.val(""),
                            o.currentPage.removeClass(
                                "flipbook-color-transparent"
                            );
                    })),
            ...
            createMenuHeader: function (e, t, o) {
                var i = this,
                    n = M("<div>")
                        .addClass(
                            "flipbook-menu-header skin-clor flipbook-font"
                        )
                        .appendTo(e),
                    s =
                        ((t = M("<span>")
                ...
                if (e || !this.pdfService || this.pdfService.outlineLoaded) {
                    if (
                        ((this.tocHolder = M("<div>")
                            .addClass(
                                "flipbook-tocHolder flipbook-side-menu skin-color-bg"
                            )
                            .appendTo(this.wrapper)
                            .hide()),
            ...
            createTocItem: function (o, e, t) {
                        ...
                        M(C.createElement("a"))
                            ...
                            .bind("touchend click", function (e) {
                                if (
                                    ...
                                    if (
                                        (i.options.tableOfContentCloseOnClick &&
                                            i.toggleToc(!1),
                                        !o.page && o.dest)
                                    )
                ...
                t || (t = 0),
                    ...
                    t
                        ...
                        : (n.css("margin-right", "15px"),
                          n.css("padding-left", "10px"));
            ...
            togglePrintMenu: function () {
                ...
                if (this.printMenu)
                    ...
                    var e = M(
                            '<idv class="flipbook-sub-menu-center">'
                ...
                function t() {
                    ...
                    for (var t = "", o = 0; o < n.options.pages.length; o++)
                        n.options.pages[o].src &&
                            (t +=
                                '<img src="' +
                                n.options.pages[o].src.toString() +
                                '"/>\n');
                    var i =
            ...
            initEasing: function () {
                L.jQuery.extend(L.jQuery.easing, {
                    ...
                    easeInExpo: function (e, t, o, i, n) {
                        return 0 == t
                            ? o
                            : i * Math.pow(2, 10 * (t / n - 1)) + o;
                    },
                    easeOutExpo: function (e, t, o, i, n) {
                        return t == n
                            ? o + i
                            : i * (1 - Math.pow(2, (-10 * t) / n)) + o;
                    },
                    ...
                    easeInBounce: function (e, t, o, i, n) {
                        return (
                            i - M.easing.easeOutBounce(e, n - t, 0, i, n) + o
                        );
                    },
            ...
            if (
                ...
                M(o).bind("pagechange", function () {
                    ...
                    (this.thumbHolder = M(C.createElement("div"))
                        .addClass(
                            "flipbook-thumbHolder flipbook-side-menu skin-color-bg"
                        )
                        .appendTo(e)
                        .hide()),
                    ...
                    (this.$findInput = this.$searchBar
                        ...
                        .keyup(function () {
                            ...
                            if (
                                ...
                                o.unmark(),
                                "" != e &&
                                    ((o.searchingString = e), o.pdfService))
                            )
                                for (
                                    var t = 0;
                                    t < o.pdfService.pdfInfo.numPages;
                                    t++
                                )
                                    i.findInPage(e, t);
                        })),
                    (this.$findInfo = this.$searchBar.find(
                        ".flipbook-find-info"
                    )),
                    (this.thumbs = []);
                var t = n.pages,
                ...
                (this.thumbScroll = new FLIPBOOK.IScroll(
                    this.thumbsWrapper[0],
                    {
                        bounce: !1,
                        mouseWheel: !0,
                        scrollbars: !0,
        ...
        (FLIPBOOK.Thumbnails.prototype = {
                ...
                this.main.pdfDocument.getPage(e + 1).then(function (e) {
                    ...
                    (e.cleanupAfterRender = !0),
                        e.render(a).then(function () {
                            e.cleanup(),
                                e.pageIndex + 1 <
                                    l.main.pdfDocument._pdfInfo.numPages &&
            ...
            showBookmarkedThumbs: function () {
                ...
                this.thumbsWrapper.css(
                    "top",
                    50 + this.bookmark.height() + "px"
                );
            },
            show: function () {
        ...
        (FLIPBOOK.getFlipbookSrc = function () {
            for (
                var e = C.getElementsByTagName("script"), t = 0;
                t < e.length;
                t++
            ) {
        ...
        (FLIPBOOK.pdfjsSrc = FLIPBOOK.flipbookSrc.replace(
            "/flipbook.",
            "/pdf."
        )),
                        ...
                        function (e) {
                            ...
                            (i = i || s.documentElement),
                                / Version\/5\.1(?:\.\d+)? Safari\//.test(
                                    ...
                                    ? i[t]()
                                    : i[t](
                                          n ? Element.ALLOW_KEYBOARD_INPUT : {}
                                      ),
                                this.on("change", o);
                        }.bind(this)
                    );
        ...
        function i(e, f) {
                        ...
                        return (
                            ...
                            !i || G === f.fingers || f.fingers === Be || k()
                                ? ((ee = E()),
                                  2 == G &&
                                      (O(1, i[1]),
                                      (W = V = I(J[0].start, J[1].start))),
                                  (f.swipeStatus || f.pinchStatus) &&
                                      (o = m(t, X)))
                                : (o = !1),
                            !1 === o
                                ? (m(t, (X = Me)), o)
                ...
                if (X !== ye && X !== Me && !x()) {
                    ...
                    if (
                        ...
                        if (
                            ...
                            (a = R),
                            (s = N) != ge &&
                                ((a = Math.max(a, M(s))), (Q[s].distance = a)),
                            (h = m(d, X)),
            ...
            function i(e) {
                ...
                if (i) {
                    if (i.length && !x())
                        return (
                            (t = o), (oe = E()), (ie = t.touches.length + 1), !0
                        );
            ...
            try {
                ...
                re.error(
                    "events not supported " + A + "," + H + " on jQuery.swipe"
                );
            }
            ...
            (o = (function () {
                ...
                return (
                    ...
                    (e.prototype.is_encoded = function (e) {
                        return (
                            (e = e.to_rfc3986()), decodeURIComponent(e) !== e
                        );
                    }),
                    (e.prototype.encode = function (e) {
                        return void 0 === e || this.is_encoded(e)
                            ? e
                            : e.to_rfc3986();
                    }),
        ...
        return (function (e) {
            ...
            return (
                    ...
                    for (
                        s = e,
                            ...
                            document.getElementById(
                                ...
                                this.config.networks.google_plus.display,
                ...
                (t.prototype.event_open = function (e) {
                    return (
                        this.has_class(e, "load") &&
                            this.remove_class(e, "load"),
                ...
                (t.prototype.public = function (e) {
                    ...
                    for (
                        a = [],
                            i = o = 0,
                            n = (s = document.querySelectorAll(this.element))
                                .length;
                        o < n;
                        i = ++o
                    )
                    ...
                    return this.config.networks.facebook.load_sdk
                        ? window.FB
                            ? FB.ui({
                                  ...
                                  caption:
                                      this.config.networks.facebook.caption,
                                  description:
                                      this.config.networks.facebook.description,
                              })
                            : console.error(
                                  "The Facebook JS SDK hasn't loaded yet."
                              )
                        : this.popup(
                ...
                (t.prototype.network_pinterest = function () {
                    return this.popup(
                        "https://www.pinterest.com/pin/create/button",
                        {
                            ...
                            description:
                                this.config.networks.pinterest.description,
                        }
                    );
                }),
