...
(FLIPBOOK.Book3 = function (t, e, i) {
    ...
    (FLIPBOOK.Book3.prototype.updateVisiblePages = function (t) {
        ...
        for (
            ...
            s == this.flippedleft
                ...
                this.pagesArr[s]._setStyle(
                    this.pagesArr[s].wrapper.style,
                    i,
                    ""
                );
        ...
        if (this.enabled && !this.flipping)
            if (
                ...
                (this.goingToPage = t) > this.rightIndex
                    ? ((end = 180),
                      (o.angle <= 0 || 180 <= o.angle || !o.angle) &&
                          (o.angle = 1))
                    : t < this.rightIndex &&
                      ((end = -180),
                      (0 <= o.angle || o.angle <= -180 || !o.angle) &&
                          (o.angle = -1)),
    ...
    (FLIPBOOK.Book3.prototype.applyAngles = function (t, e, i, s, o) {
        i < s
            ? (t && (t.show(), t._setAngle(i + o)),
              e && (e.hide(), e._setAngle(45)))
            : (e && (e.show(), e._setAngle(i + o)),
              t && (t.hide(), t._setAngle(45)));
    }),
    ...
    (FLIPBOOK.Book3.prototype.onResize = function () {
        ...
        function c() {
            l.scroll && (l.scroll.options.zoomMin = l.ratio * p.zoomMin),
                ...
                l.scroll &&
                    l.scroll.zoom(l.ratio * p.main.zoom, e / 2, i / 2, 0);
        }
        ...
        o.pagePreloader
            ...
            this.options.singlePageMode
                ...
                ? (this.$wrapper
                      .css(
                          "left",
                          String(this.book.options.pageWidth - 1) + "px"
                      )
