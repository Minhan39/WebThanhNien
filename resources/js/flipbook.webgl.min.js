...
(FLIPBOOK.PageWebGL = function (t, e, i, o, s, n) {
    ...
    (this.cube = new THREE.Mesh(this.gF, a)),
        ...
        (this.pageFlippedAngle =
            (Math.PI * this.options.pageFlippedAngle) / 180),
        ...
        (this.b2.offset = 0.98),
        this.b2.setAngle(1),
        (this.modF = new MOD3.ModifierStack(
            new MOD3.LibraryThree(),
            this.cube
        )),
                          ...
                          if (t) {
                              if (t.canvas) s.onPageCanvasLoaded(t, "front", i);
                                  ...
                                  (e.image = t.image),
                                      ...
                                      (e.needsUpdate = !0),
                                      "left" ==
                                      s.options.pages[2 * s.index].side
                                          ? (e.repeat.x = 0.5)
                                          : "right" ==
                                                s.options.pages[2 * s.index]
                                                    .side &&
                                            ((e.repeat.x = 0.5),
                                            (e.offset.x = 0.5)),
                            ...
                            if (t) {
                                if (t.canvas)
                                    ...
                                    (e.image = t.image),
                                        ...
                                        (e.needsUpdate = !0),
                                        "left" ==
                                        s.options.pages[2 * s.index + 1].side
                                            ? (e.repeat.x = 0.5)
                                            : "right" ==
                                                  s.options.pages[
                                                      2 * s.index + 1
                                              ...
                                              ((e.repeat.x = 0.5),
                                              (e.offset.x = 0.5)),
                                        (s.backMaterial = s.createMaterial(
                                            e,
                                            "back"
                                        )),
    ...
    (FLIPBOOK.PageWebGL.prototype.flipRightInstant = function (t) {
        if (
            ...
            !this.isFlippedRight &&
                ...
                !this.flippingLeft &&
                this.index ==
                    this.book.getNumPages() - this.book.flippedright - 1)
        ) {
            ((this.thiss = this).xx = 0),
                (this.angle = 0),
    ...
    (FLIPBOOK.BookWebGL.prototype.init3d = function () {
        ...
        ((window.renderer = s).gammaInput = !0),
            ...
            this.options.shadows &&
                ...
                (s.shadowMap.type = THREE.PCFShadowMap)),
        ...
        if (
            ...
            if (
                ...
                var d = new THREE.Mesh(
                    new THREE.BoxGeometry(1e4, 1e4, 1, 1, 1, 1),
                    l
                );
                ...
                if (e.rendering) {
                    ...
                    FLIPBOOK.TWEEN.update(),
                        e.needsUpdate &&
                            ...
                            (e.needsUpdate = !1),
                            e.htmlLayer &&
                                e.cssRenderer.render(e.Scene, e.Camera));
                }
    ...
    (FLIPBOOK.BookWebGL.prototype.initHtmlContent = function () {
        ...
        this.wrapper.appendChild(this.cssRenderer.domElement),
            ...
            (this.cssRenderer.domElement.className =
                "cssRenderer " + Math.random());
        var i = this;
    ...
    (FLIPBOOK.BookWebGL.prototype.isZoomed = function () {
        return (
            this.options.zoom > this.options.zoomMin && 1 < this.options.zoom
        );
    }),
    ...
    (FLIPBOOK.BookWebGL.prototype.createPages = function () {
        ...
        if (
            ((g.needsUpdate = !0), (o.specularF = g), o.options.pagePreloader)
        ) {
            ...
            o.options.lights
                ...
                : (u = f =
                      new THREE.MeshBasicMaterial({ map: m, color: 15592941 }));
        } else
            o.options.lights
                ? ((u = new THREE.MeshStandardMaterial({
                      roughness: o.options.pageRoughness,
    ...
    (FLIPBOOK.BookWebGL.prototype.turnPageComplete = function () {
        for (
            var t = this.pages, e = (this.options.main, 0);
            e < t.length;
            e++
        ) {
    ...
    (FLIPBOOK.BookWebGL.prototype.focusBoth = function (t, e) {
        (this.isFocusedLeft() || this.isFocusedRight()) &&
            this.moveToPos(0, t, e);
    }),
    ...
    (FLIPBOOK.BookWebGL.prototype.loadMorePages = function () {
        for (
            ...
            (o = this.pages[this.flippedleft + s]) &&
    ...
    (FLIPBOOK.BookWebGL.prototype.updateHtmlLayer = function () {
        if (this.htmlLayer) {
            ...
            if (this.options.doublePage)
                ...
                if ((this.$pageC.hide(), 0 == this.rightIndex))
                    this.$pageL.hide();
                else if (this.options.pages[i].htmlContent) {
                    this.$pageLInner.empty();
                    jQuery(this.options.pages[i].htmlContent).appendTo(
                        this.$pageLInner
                    );
                    this.$pageL.show(), (this.htmlLayerVisible = !0);
                } else this.$pageL.hide();
                if (this.rightIndex == 2 * this.pages.length)
                    this.$pageR.hide();
                else if (this.options.pages[e].htmlContent) {
                    this.$pageRInner.empty();
                    jQuery(this.options.pages[e].htmlContent).appendTo(
                        this.$pageRInner
                    );
                    this.$pageR.show(), (this.htmlLayerVisible = !0);
                } else this.$pageR.hide();
    ...
    (FLIPBOOK.BookWebGL.prototype.zoomTo = function (t, e, i, o) {
        if (!this.zooming) {
            ...
            if (
                ((newZoom =
                    t > this.options.zoomMax ? this.options.zoomMax : t),
    ...
    (function (a) {
        (a.Vector3 = function (t, e, i) {
            ...
            (a.Vector3.prototype.divide = function (t) {
                return (
                    (t = 1 / t),
                    new a.Vector3(this.x * t, this.y * t, this.z * t)
                );
            }),
        ...
        (P.Bend = function (t, e, i) {
            ...
            (P.Bend.prototype.setModifiable = function (t) {
                P.Modifier.prototype.setModifiable.call(this, t),
                    (this.max = this.switchAxes
                        ? this.mod.midAxis
                        : this.mod.maxAxis),
                    (this.min = this.mod.minAxis),
                    (this.mid = this.switchAxes
                        ? this.mod.maxAxis
                        : this.mod.midAxis),
                ...
                if (0 != this.force)
                    for (
                        var t,
                            ...
                            m =
                                P.Constants.doublePI *
                                (r / (g * P.Constants.doublePI)),
                            y = 1 / r,
                        ...
                        (t = (r = s[n]).getValue(p)),
                            ...
                            (this.constraint == P.ModConstant.LEFT && o <= h) ||
                                (this.constraint == P.ModConstant.RIGHT &&
                                    h <= o) ||
                                ((t = M((o = x - m * h + m * o)) * (g + i)),
                                (o = v(o) * (g + i)),
                                (i = t - g),
    ...
    (function (h) {
        (h.Twist = function (t) {
            ...
            (h.Twist.prototype.twistPoint = function (t, e) {
                var i = new h.Matrix4().translationMatrix(
                    t.getX(),
                    t.getY(),
                    t.getZ()
                );
        ...
        (h.Wheel = function () {
            ...
            (h.Wheel.prototype.apply = function () {
                ...
                for (
                    r =
                        0 != s
                            ? ((t = new h.Matrix4().rotationMatrix(
                                  o.x,
                                  o.y,
                                  o.z,
                                  s
        ...
        (t.VertexJ3D = function (t) {
            ...
            (t.VertexJ3D.prototype.setX = function (t) {
                ...
                (e.vertexPositionBuffer.data[this.vertex] = t),
                    e.replaceArray(
                        e.vertexPositionBuffer,
                        e.vertexPositionBuffer.data
                    );
            }),
        ...
        (r.MeshCopperlicht = function () {}),
            ...
            (r.MeshCopperlicht.prototype.setMesh = function (t) {
                ...
                for (var e = [], i = 0; i < t.length; i++)
                    for (
                        var o = (e = t[i].Vertices).length, s = 0;
                        s < o;
                        s++
                    ) {
                ...
                (function t(e, i, o) {
                    if (e instanceof FLIPBOOK.CSS3DObject) {
                        ...
                        if (void 0 === r || r !== s) {
                            ...
                            u && (h.distanceToCameraSquared = m(i, e)),
                                l.objects.set(e, h);
                        }
