      ...
      <div class="container_grid">
        ...
        <div class="carousel-images">
          <div class="card_small card_exp">
            <img
              class="img_card"
              src="{{asset('images/an_tay/an_tay_1.jpg')}}"
              alt=""
            />
          </div>
          <div class="card_small card_exp">
            <img
              class="img_card"
              src="{{asset('images/an_tay/an_tay_2.jpg')}}"
              alt=""
            />
          </div>
          <div class="card_medium card_exp">
            <img
              class="img_card"
              src="{{asset('images/an_tay/an_tay_3.jpg')}}"
              alt=""
            />
          </div>
          <div class="card_large card_exp">
            <img
              class="img_card"
              src="{{asset('images/an_tay/an_tay_4.jpg')}}"
              alt=""
            />
          </div>
          <div class="card_small card_exp">
            <img
              class="img_card"
              src="{{asset('images/an_tay/an_tay_5.jpg')}}"
              alt=""
            />
          </div>
          <div class="card_small card_exp">
            <img
              class="img_card"
              src="{{asset('images/an_tay/an_tay_6.jpg')}}"
              alt=""
            />
          </div>
          <!-- <div class="card_medium card_exp">
