...
<html>
  ...
  <body>
    <header>
      ...
      <h2>Uỷ ban Hội phường Hoà Lợi</h2>
    </header>
      ...
      <div class="container_grid">
        ...
        <div class="carousel-images">
          <div class="card_small card_exp">
            <img
              class="img_card"
              src="{{asset('images/hoa_loi/hoa_loi_1.jpg')}}"
              alt=""
            />
          </div>
          <div class="card_small card_exp">
            <img
              class="img_card"
              src="{{asset('images/hoa_loi/hoa_loi_2.jpg')}}"
              alt=""
            />
          </div>
          <div class="card_medium card_exp">
            <img
              class="img_card"
              src="{{asset('images/hoa_loi/hoa_loi_3.jpg')}}"
              alt=""
            />
          </div>
          <div class="card_large card_exp">
            <img
              class="img_card"
              src="{{asset('images/hoa_loi/hoa_loi_4.jpg')}}"
              alt=""
            />
          </div>
          <div class="card_small card_exp">
            <img
              class="img_card"
              src="{{asset('images/hoa_loi/hoa_loi_5.jpg')}}"
              alt=""
            />
          </div>
          <div class="card_small card_exp">
            <img
              class="img_card"
              src="{{asset('images/hoa_loi/hoa_loi_6.jpg')}}"
              alt=""
            />
          </div>
          <!-- <div class="card_medium card_exp">
