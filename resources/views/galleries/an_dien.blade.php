      ...
      <div class="container_grid">
        ...
        <div class="carousel-images">
          <div class="card_small card_exp">
            <img
              class="img_card"
              src="{{asset('images/an_dien/an_dien_1.jpg')}}"
              alt=""
            />
          </div>
          <div class="card_small card_exp">
            <img
              class="img_card"
              src="{{asset('images/an_dien/an_dien_2.jpg')}}"
              alt=""
            />
          </div>
          <div class="card_medium card_exp">
            <img
              class="img_card"
              src="{{asset('images/an_dien/an_dien_3.jpg')}}"
              alt=""
            />
          </div>
          <div class="card_large card_exp">
            <img
              class="img_card"
              src="{{asset('images/an_dien/an_dien_4.jpg')}}"
              alt=""
            />
          </div>
          <div class="card_small card_exp">
            <img
              class="img_card"
              src="{{asset('images/an_dien/an_dien_5.jpg')}}"
              alt=""
            />
          </div>
          <div class="card_small card_exp">
            <img
              class="img_card"
              src="{{asset('images/an_dien/an_dien_6.jpg')}}"
              alt=""
            />
          </div>
          <!-- <div class="card_medium card_exp">
