      ...
      <div class="container_grid">
        ...
        <div class="carousel-images">
          <div class="card_small card_exp">
            <img
              class="img_card"
              src="{{asset('images/phu_an/phu_an_1.jpg')}}"
              alt=""
            />
          </div>
          <div class="card_small card_exp">
            <img
              class="img_card"
              src="{{asset('images/phu_an/phu_an_2.jpg')}}"
              alt=""
            />
          </div>
          <div class="card_medium card_exp">
            <img
              class="img_card"
              src="{{asset('images/phu_an/phu_an_3.jpg')}}"
              alt=""
            />
          </div>
          <div class="card_large card_exp">
            <img
              class="img_card"
              src="{{asset('images/phu_an/phu_an_4.jpg')}}"
              alt=""
            />
          </div>
          <div class="card_small card_exp">
            <img
              class="img_card"
              src="{{asset('images/phu_an/phu_an_5.jpg')}}"
              alt=""
            />
          </div>
          <div class="card_small card_exp">
            <img
              class="img_card"
              src="{{asset('images/phu_an/phu_an_6.jpg')}}"
              alt=""
            />
          </div>
          <!-- <div class="card_medium card_exp">
